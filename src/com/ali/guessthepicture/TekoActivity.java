...
public class TekoActivity extends Activity {
	EditText jawabanTxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_teko);
		//cari komponen editText1
			...
			public void cekJawaban(View v){
				String JawabanBenar = "TEKO BENGKOK";
			...
			// pean Toast
					...
					Intent i = new Intent(getApplicationContext(), TuangActivity.class);
					startActivity(i);
				}
				else{
					//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.teko, menu);
		return true;
	}
