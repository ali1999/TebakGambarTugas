...
public class Belasan extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_belasan);
	...
	public void cekJawaban(View v){
		String JawabanBenar = "BELASAN KORBAN MATI KELAPARAN";
	...
	// pean Toast
			...
			Intent i = new Intent(getApplicationContext(), DarahActivity.class);
			startActivity(i);
		}
		else{
			//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.belasan, menu);
		return true;
	}
