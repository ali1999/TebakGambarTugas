...
public class SedotActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sedot);
		//cari komponen editText1
			...
			public void cekJawaban(View v){
				String JawabanBenar = "SEDOT UPIL";
			...
			// pean Toast
					...
					Intent i = new Intent(getApplicationContext(), SolidaritasActivity.class);
					startActivity(i);
				}
				else{
					//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sedot, menu);
		return true;
	}
