...
public class TuangActivity extends Activity {
	EditText jawabanTxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tuang);
		//cari komponen editText1
			...
			public void cekJawaban(View v){
				String JawabanBenar = "TUANG KOPI";
			...
			// pean Toast
					...
					Intent i = new Intent(getApplicationContext(), Tamat.class);
					startActivity(i);
				}
				else{
					//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tuang, menu);
		return true;
	}
