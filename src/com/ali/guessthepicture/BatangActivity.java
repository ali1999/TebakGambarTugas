...
public class BatangActivity extends Activity {
	EditText jawabanTxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_batang);
	...
	public void cekJawaban(View v){
		String JawabanBenar = "BATANG POHON RAMBUTAN ROBOH";
	...
	// pean Toast
			...
			Intent i = new Intent(getApplicationContext(), Belasan.class);
			startActivity(i);
		}
		else{
			//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.batang, menu);
		return true;
	}
