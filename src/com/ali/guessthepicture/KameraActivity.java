...
public class KameraActivity extends Activity {
	...
	public void cekJawaban(View v){
		String JawabanBenar = "KAMERA RUSAK";
	...
	// pean Toast
			...
			Intent i = new Intent(getApplicationContext(), KhususActivity.class);
			startActivity(i);
		}
		else{
			//Pesan TOast
			Toast.makeText(getApplicationContext(), "JAWABAN MASIH SALAH!", 
