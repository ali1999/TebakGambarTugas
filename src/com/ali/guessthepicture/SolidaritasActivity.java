...
public class SolidaritasActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_solidaritas);
		//cari komponen editText1
			...
			public void cekJawaban(View v){
				String JawabanBenar = "SOLIDARITAS BURUH";
			...
			// pean Toast
					...
					Intent i = new Intent(getApplicationContext(), TekoActivity.class);
					startActivity(i);
				}
				else{
					//Pesan TOast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.solidaritas, menu);
		return true;
	}
